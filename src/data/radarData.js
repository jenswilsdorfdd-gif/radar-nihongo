export const radarData = {
    ...
    1: {
      morningRoutine: "Stellen Sie sich nach dem Aufstehen direkt vor den Spiegel. Sehen Sie sich in die Augen und fragen Sie entschlossen: えきは どこですか？ und トイレは どこですか？\n\nWenn Sie heute Ihre Haustür abschließen, tippen Sie auf den Türrahmen und fragen Sie den Rahmen laut auf Japanisch, wo der Bahnhof ist.",
      scenarios: [
        {
    ...
    2: {
      morningRoutine: "Dieses Training findet in der realen Welt statt. Wenn Sie zur Arbeit fahren oder spazieren gehen: Jedes Mal, wenn Sie an einer Kreuzung rechts abbiegen, sagen Sie hörbar みぎ. Bei links sagen Sie ひだり. Gehen Sie über eine Ampel, sagen Sie まっすぐ.",
      scenarios: [
        {
    ...
    3: {
      morningRoutine: "Gehen Sie durch Ihre Wohnung. Öffnen Sie den Kühlschrank. Zeigen Sie auf die Milch und fragen Sie den Kühlschrank laut: [Milch] + はありますか？. Zeigen Sie auf Ihre Kaffeemaschine und fragen Sie: [Kaffee] + はありますか？.",
      scenarios: [
        {
