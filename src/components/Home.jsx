...
const Home = ({ 
  ...
  const texts = {
    ...
    jpn: {
      ...
      info: "ロードマップ",
      subtitle: "Language Survival System",
      phase1ReadTitle: "フェーズ 1: 仮名 (読む)",
      phase1ReadDesc: "視覚的な文字トレーニング。脳の絶対的な基礎。",
      phase1WriteTitle: "フェーズ 1: 仮名 (書く)",
      phase1WriteDesc: "マスタークラス。正確な筆順を記憶する。",
      particleTitle: "助詞コード",
      particleDesc: "マトリックスを解読する。",
      particleLockedDesc: "フェーズ1を完全にクリアすると、助詞コードがアンロックされます。",
      phase2FlowTitle: "フェーズ 2: 仮名フロー",
      phase2FlowDesc: "レーダーへのブリッジトレーニング：3つのレベル（日常、テキスト、対話）で流暢な読解を練習。",
      phase2LockedDesc: "このミッションをアンロックするには、フェーズ1をクリアしてください。",
      phase3Title: "フェーズ 3: 21日間レーダー",
      phase3Desc: "日常サバイバルのためのストレステスト、語彙、反応力。",
      phase3LockedDesc: "レーダーをアンロックするには、フェーズ2（仮名フロー）をクリアしてください。",
      phase4Title: "フェーズ 4: 漢字 N5",
      phase4Desc: "複雑な文字の意味、読み方、応用を学ぶ。",
      phase4LockedDesc: "漢字トレーニングをアンロックするには、フェーズ3（レーダー）をクリアしてください。",
      examTitle: "最終試験",
      examDesc: "究極の30問ストレステスト。実力を証明しよう。",
      examLockedTitle: "試験ロック中",
      examLockedDesc: "最終テストをアンロックするには、すべてのフェーズを完全にクリアしてください。",
      groupTitle: "ライブ道場: グループトレーニング",
      groupDesc: "知識を応用しよう！インタラクティブなライブ練習への登録はこちら。",
      groupBtn: "今すぐ登録",
      day: "日",
      scenario: "テキスト",
      socialTitle: "毎日の言語ハック",
      socialDesc: (
        <>
          ヒント、語彙、モチベーションをスマホに直接お届け。<br />
          集中力を維持しよう！
        </>
      ),
      modalTitle: "8週間ロードマップ",
      modalIntro: "このシステムは従来の単語帳ではなく、現実の日常生活のための戦術的ブートキャンプです。理論より実践！",
      modalW1Title: "第1〜2週: 基礎",
      modalW1Desc: "毎日1回 フェーズ1（読む）、続いてフェーズ1（書く）。14日後には絶対的な基礎が完全に定着します。",
      modalW3Title: "第3〜5週: ミッション",
      modalW3Desc: "フェーズ2（フロー）とフェーズ3（レーダー）を並行して実行！テキストで準備運動をし、その日のレーダーミッションを完了します。",
      modalW6Title: "第6〜8週: 仕上げ",
      modalW6Desc: "フェーズ4。毎日1つの新しいデッキ。反応速度を上げるために、過去のレーダーミッションも並行して復習します。",
      modalCtaTitle: "第8週以降: ライブ道場",
      modalCtaDesc: "知識だけでは不十分です。実践あるのみ！インタラクティブなグループトレーニングに登録し、実際の会話で反射神経を鍛えましょう。",
      modalCtaBtn: "今すぐ道場に登録する",
      modalClose: "了解しました",
      regTitle: "道場登録",
      regSubtitle: "ライブトレーニングに申し込む。",
      fName: "名",
      lName: "姓",
      phone: "電話番号",
      email: "メールアドレス",
